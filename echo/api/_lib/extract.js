...
function systemPrompt(knownEvents, nowIso) {
  const known = (knownEvents || [])
    ...
    .join('\n');
  return (
    `Ты анализируешь посты Telegram-канала организатора вечеринок ECHO в Оренбурге ` +
    `(двойной формат в одну дату: дневная тусовка 14+ обычно 16:00-21:00 без алкоголя ` +
    `и ночная 18+ обычно 00:00-10:00; площадка — ул. Монтажников 2/1). ` +
