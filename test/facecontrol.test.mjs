...
test('shareText содержит вердикт и ссылку', () => {
  ...
  assert.ok(t.includes('ТЫ В СПИСКЕ') && t.includes('https://example.com'));
});
